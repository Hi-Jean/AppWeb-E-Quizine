                                    ...
                                    <nav>
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li class='button-header'><a href='". base_url() ."index.php/compte/fermer' class='btn btn3'>Déconnexion</a></li>";
                                                     ...
                                                     echo "<li class='button-header margin-left '><a href='". base_url() ."index.php/compte/creer' class='btn'>Join</a></li>
                                            <li class='button-header'><a href='". base_url() ."index.php/compte/connecter' class='btn btn3'>Log in</a></li>";
                                                }
