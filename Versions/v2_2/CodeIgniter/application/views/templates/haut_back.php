	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">E-Quizine</span>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Accueil Responsable</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Votre Profil</span>
					...
					<?php
						...
						if($this->session->userdata('role') == 'F') {
							echo "<li class='sidebar-item ". (isset($quiz) ? "active" : "") ."'>
						<a class='sidebar-link' href='". base_url() ."index.php/quiz/liste_quiz'>
              <i class='align-middle' data-feather='list'></i> <span class='align-middle'>Les Quiz</span>
            </a>
					</li>";

						} else {
							echo "<li class='sidebar-item ". (isset($liste) ? "active" : "") ."'>
						<a class='sidebar-link' href='". base_url() ."index.php/compte/lister_profils'>
              <i class='align-middle' data-feather='users'></i> <span class='align-middle'>Profils utilisateurs</span>
            </a>
					</li>";
						}
